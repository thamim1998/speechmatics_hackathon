...
//     const sleepByDay = {}; // e.g. avg duration if you store it in data.durationMinutes
...
//       const day = ts ? dateKey(ts) : null;
  
//       if (type === 'incident' && day) {
...
//       avgSleepByDay[day] = Math.round(v.total / v.count);
//     }
  
//     // simple flags (you can evolve later)
//     const flags = [];
//     const incidentTotal = Object.values(incidentsByDay).reduce((a, b) => a + b, 0);
...
//       countsBySource,
//       incidentsByDay,
//       avgSleepMinutesByDay: avgSleepByDay,
//       flags,
//     };
//   }
